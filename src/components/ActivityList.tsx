...
export default function ActivityList({activities, dispatch}: ActivityListProps) {
    ...
    const categoryName = useMemo(() => 
        //cat es una variable temporal que se usara para iterar sobre categories
  ...
  return (
    <>
        ...
        activities.map( activity => (
            <div key={activity.id} className="px-5 p-10 bg-white mt-5 flex justify-between shadow">
